...
namespace ManualSamples
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void button5_Click(object sender, System.EventArgs e)
		{
			...
			// show it
			string fileName = @"c:\temp\graphics.pdf";
			g.Save(fileName);
			System.Diagnostics.Process.Start(fileName);
		...
		private void button7_Click(object sender, System.EventArgs e)
		{
			...
			// save and show
			string fileName = @"c:\temp\landscape.pdf";
			pdf.Save(fileName);
			System.Diagnostics.Process.Start(fileName);
		}
		...
		private void button8_Click(object sender, System.EventArgs e)
		{
			...
			// save and show
			string fileName = @"c:\temp\links.pdf";
			pdf.Save(fileName);
			System.Diagnostics.Process.Start(fileName);
		}
		...
		private void button10_Click(object sender, System.EventArgs e)
		{
			...
			string fileName = @"c:\temp\bezier.pdf";
			pdf.Save(fileName);
			System.Diagnostics.Process.Start(fileName);
		}
		...
		private void button11_Click(object sender, System.EventArgs e)
		{
			...
			// save document
			string fileName = @"c:\temp\beziers.pdf";
			pdf.Save(fileName);
			System.Diagnostics.Process.Start(fileName);
		}
		...
		private void button12_Click(object sender, System.EventArgs e)
		{
			...
			// step 3: save the document to a file
			string fileName = @"c:\temp\images.pdf";
			pdf.Save(fileName);
			System.Diagnostics.Process.Start(fileName);
		}
		...
		private void button13_Click(object sender, System.EventArgs e)
		{
			...
			string fileName = @"c:\temp\drawline.pdf";
			pdf.Save(fileName);
			System.Diagnostics.Process.Start(fileName);
		}
		...
		private void button14_Click(object sender, System.EventArgs e)
		{
			...
			// save the document to a file
			string fileName = @"c:\temp\drawlines.pdf";
			pdf.Save(fileName);
			System.Diagnostics.Process.Start(fileName);
		}
		...
		private void button15_Click(object sender, System.EventArgs e)
		{
			...
			// save the document to a file
			string fileName = @"c:\temp\drawpie.pdf";
			pdf.Save(fileName);
			System.Diagnostics.Process.Start(fileName);
		}
		...
		private void button16_Click(object sender, System.EventArgs e)
		{
			...
			// save the document to a file
			string fileName = @"c:\temp\poly.pdf";
			pdf.Save(fileName);
			System.Diagnostics.Process.Start(fileName);
		}
		...
		private void button17_Click(object sender, System.EventArgs e)
		{
			...
			// save the document to a file
			string fileName = @"c:\temp\rect.pdf";
			pdf.Save(fileName);
			System.Diagnostics.Process.Start(fileName);
		}
		...
		private void button18_Click(object sender, System.EventArgs e)
		{
			...
			// save the document to a file
			string fileName = @"c:\temp\string.pdf";
			pdf.Save(fileName);
			System.Diagnostics.Process.Start(fileName);
		}
		...
		private void button20_Click(object sender, System.EventArgs e)
		{
			...
			// save the document to a file
			string fileName = @"c:\temp\measure.pdf";
			pdf.Save(fileName);
			System.Diagnostics.Process.Start(fileName);
		}
		...
		private void button21_Click(object sender, System.EventArgs e)
		{
			...
			// save the document to a file
			string fileName = @"c:\temp\pages.pdf";
			pdf.Save(fileName);
			System.Diagnostics.Process.Start(fileName);
		}
	}
