    ...
    public class Master
    {
        ...
        public void connect(string ip, ushort port)
        {
            try
            {
                ...
                if (GlobalData.SystemStatus == SystemStatuses.NotConnected) GlobalData.SystemStatus = SystemStatuses.SystemReady; 

            }
            catch (Exception)
            {
                _connected = false;
                System.Windows.Forms.MessageBox.Show("ÍøÂçÁ¬½Ó´íÎó");
